...
**Health score as a circular ring.** A single 0–100 number with a color-coded ring (green/yellow/red) lets a developer assess the repo in under a second. I put it top-right so it does not interrupt the name and description scan path.
